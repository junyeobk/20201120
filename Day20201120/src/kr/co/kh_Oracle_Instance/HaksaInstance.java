...
public class HaksaInstance {
	public String register(String protocol,BufferedReader input,Statement stmt,Connection conn,int cnt)throws IOException,SQLException {
	   ...
	   public void search(BufferedReader input,Statement stmt,Connection conn)throws IOException,SQLException {
	   ...
	   public void delete(BufferedReader input,Statement stmt,Connection conn)throws IOException,SQLException {
	   ...
	   public void list(Statement stmt,Connection conn)throws IOException,SQLException {
				stmt=conn.createStatement();
